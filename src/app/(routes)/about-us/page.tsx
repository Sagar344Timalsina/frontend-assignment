...
const AboutUs = () => {
  return (
    <main className='contact-main dynamic-x-padding dynamic-y-padding'>
      ...
      <section className="child-about grid grid-cols-12 py-8">
        <article className="left-about grid-items col-span-3">
          <h4 className='text-xl font-poppins'>What we do?</h4>
          <p className='w-72 font-poppins text-center'>
        ...
        <article className="mid-about grid-items col-span-3">
        ...
        <article className="right-about grid-items col-span-3">
